...
| `unova/0591/0000` Amoonguss | `3DS - Pokedex 3D Pro - … #0591 Amoonguss.zip`, a rigged COLLADA model (replaces the earlier `amoonguss.zip` render) | Not in the collection yet. Rendered, not drawn. Model edits: cap 1.15×, arm-caps 1.2×, arm stalks thickened; the face (eyes and nose together, proportions kept) 1.7× from the eyes' top edge; pupils redrawn as smooth ellipses 3× wide, 2.5× long in the eye texture. Rendered at 40 px a unit, 12° camera, three bands from an overhead light; pixel stage: colour families (nose pink kept apart), black outline outside the shape, same-hue lines, specks and spurs cleaned; frames sized to fit. 18-bit. Idle and Charge are the model's own motion; the rest is posed. No author; no credits. |
