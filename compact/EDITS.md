...
| `unova/0538/0000` Throh | `3DS - Pokedex 3D Pro - … #0538 Throh.zip`, a rigged COLLADA model (`model.dae`, `anim.dae`) | Not in the collection yet. Rendered, not drawn, as Amoonguss: 20° down, 26 px a unit, two-tone lighting, outlines, one 9-colour 18-bit palette (3 reds). Idle (keys 402–521), Attack and Double (the appeal's throws, 128–172 and 128–212) and Charge (60–84) are the model's own motion; Walk, Hurt, Sleep, Hop and Rotate are posed from its bones. Sleep and Hurt use the eye texture's closed and half-closed rows. No author; no credits. |
| `unova/0538/0000` shiny | `unova/0538/0000` regular | Recoloured from the regular to the Gen 5 shiny sprite's colours, snapped to 18-bit: `edits/0538-0000-regular-shiny.json`. Reds to oranges one step up (the head's main red takes the main orange), gi whites to peach with in-between tones, hood and belt greys to browns. |
