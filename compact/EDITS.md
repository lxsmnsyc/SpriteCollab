...
| `unova/0591/0000` Amoonguss | `amoonguss.zip`, a rigged 3D model (`Amoonguss_idel.glb`) | Not in the collection yet. Rendered, not drawn: orthographic camera 20° down, 4.4 px a unit, 4× supersampled; two-tone lighting, black silhouette and depth-break outlines, one 8-colour 18-bit palette. Idle is the model's own loop; Walk, Attack, Hurt, Sleep, Hop, Charge and Rotate are posed from its bones. Anchors come from the Hat, Body2 and ArmHat bones. No author; no credits. |
| `unova/0591/0000` shiny | `unova/0591/0000` regular | Recoloured from the regular to the official shiny's colours, snapped to 18-bit: `edits/0591-0000-regular-shiny.json`. Pink to violet, greys to cream and tan; the face stays pink. `#865961` shades the pink and lines the grey rim, so it gets one violet-brown for both. |
